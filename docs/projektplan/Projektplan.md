...
### Ergänzungen zu 2. Technische Systemarchitektur
Neue Erweiterungen:
2.6 equed-instructor
Instructor-Ansicht aller zugewiesenen Kurse mit Bewertungen, Feedback, Zertifikatsfreigabe (sofern autorisiert)

Interne Statistiken (Badge-Level, Feedback, Kurszähler)

Kein öffentliches Profil, keine eigenständige Kurserstellung

2.7 equed-center
Verwaltungseinheit für Kursdurchführung und Instructor-Zuweisung

Kombi-Buchungslogik mit automatisierter Standortzuweisung

Zugriff auf Teilnehmer:innenverwaltung im Rahmen der eigenen Kurse

Vorbereitung Materiallogistik (Dropshipping) + optionale Faktura-Schnittstelle

2.8 equed-admin
Superadmin-Dashboard mit Zugriff auf Glossar, Zertifikatsverifikationen, Kursfreigaben, Benutzerrollen, Statistiken

Steuerung aller GPT-Vorgänge, EASY-Redaktion, Translation Review

2.9 equed-commerce (extern, optional)
Shop-Anbindung für Materialverkauf (nur aktive TN)

Pro-Aboverwaltung, Zahlungslogik, Downloadmodule

Anbindung an Shopify oder WooCommerce geplant

2.10 equed-recognition
System für externe Anerkennung (z. B. andere Hufschulen, Tierärzt:innen)

Verwaltung von Crossover-Status, Dokumentation, Prüfmodul

Integriert mit LMS-, QMS- und Zertifikatslogik
